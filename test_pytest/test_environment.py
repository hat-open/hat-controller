...
@pytest.mark.parametrize('trigger_type, trigger_name, triggered_actions', [
    ...
    ('', '', {'a3', 'a11', 'a12'}),
    ('test2/a', 'x/d', {'a2', 'a3'}),
    ('test/a', 'x/y/1', {'a3', 'a4', 'a8'}),
    ('test/a', 'x/y/1', {'a3', 'a4', 'a8'}),
    ('test/a', 'x/y/z/1', {'a3', 'a4', 'a9'}),
    ('test/a', 'x/y/a/1', {'a3', 'a4', 'a9', 'a10'}),
    ('test/a', 'x/y/a/2', {'a3', 'a4', 'a10'}),
    ('test/a', 'x/y/z/1/2', {'a3', 'a4'}),
    ])
    ...
    env_conf = {
        ...
        'actions': [
            ...
            {'name': 'a8',
             'triggers': [{'type': 'test/a',
                           'name': 'x/?/1'}],
             'code': "some random code of a8"},
            {'name': 'a9',
             'triggers': [{'type': 'test/a',
                           'name': 'x/?/?/1'}],
             'code': "some random code of a9"},
            {'name': 'a10',
             'triggers': [{'type': 'test/a',
                           'name': 'x/?/a/?'}],
             'code': "some random code of a10"},
            {'name': 'a11',
             'triggers': [{'type': '*',
                           'name': '?'}],
             'code': "some random code of a11"},
            {'name': 'a12',
             'triggers': [{'type': '?',
                           'name': '*'}],
             'code': "some random code of a12"}]}
